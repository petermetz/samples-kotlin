 ...
 * @param cordappName The name of the CordaApp that contains the flow to be invoked.
...
data class InvokeContractV1Request(
    ...
    @field:JsonProperty("signingCredential") val signingCredential: kotlin.String,
    ...
    @get:NotNull  
    @get:Size(min=1,max=1024)
    @field:JsonProperty("cordappName") val cordappName: kotlin.String,
