...
enum class FlowInvocationType(val value: kotlin.String) {
    ...
    TRACKED_FLOW_DYNAMIC("org.hyperledger.cactus.plugin.ledger.connector.corda.server.api.START_TRACKED_FLOW_DYNAMIC"),

    FLOW_DYNAMIC("org.hyperledger.cactus.plugin.ledger.connector.corda.server.api.START_FLOW_DYNAMIC");
